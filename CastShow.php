...
<table width="1401" height="1152" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
        ...
        <textarea name="showdescription" id="showdescription" cols="70" rows="6" style="color: #FFFFFF;border:none;background-color:transparent; resize:none"><?php echo $Audition_Notes ?></textarea>
        </td>
		<td>
