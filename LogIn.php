					...
					switch ($role):
						case 0://admin login
							   ...
							   //save role, email, and password in a cookie
								...
								echo "<script type='text/javascript'> window.location.assign('AdminTools.php');</script>";//redirect to admin page 
								exit;
						...
						case 2://regular user login
							   ...
							   //save email and password in a cookie
								...
								echo "<script type='text/javascript'> window.location.assign('UserTools.php');</script>";//redirect to user page  
								exit;
					endswitch;							
				}
			}
