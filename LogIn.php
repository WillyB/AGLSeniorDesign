...
<table width="1401" height="968" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<td width="174" height="37" colspan="2" background="Assets/LogIn_06.gif">&nbsp;</td>
		<td rowspan="2">
			<img src="Assets/LogIn_07.gif" width="5" height="81" alt=""></td>
		<td width="173" height="37" colspan="3" background="Assets/LogIn_08.gif">&nbsp;</td>
	...
	<tr>
		...
		<td width="226" height="38" colspan="3" background="Assets/LogIn_14.gif">&nbsp;</td>
		<td rowspan="3">
