...
<table width="1401" height="968" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<td>
			<td><input type="image" name="home" value="home" src="Assets/SearchDB_03.gif" width="106" height="35" alt=""</></td>
		<td rowspan="13">
	...
	<tr>
		<td>
		    <td><input type="image" name="logout" value="logout" src="Assets/SearchDB_05.gif width="106" height="32" alt=""</"></td>
