...
<table width="1401" height="880" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<textarea name="showdescription" cols="82" rows="13" disabled readonly id="showdescription" style="color: #FFFFFF;border:none;background-color:transparent;"><?php echo $Audition_Notes ?> a</textarea>
      </td>
		<td rowspan="14">
