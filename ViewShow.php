	...
	{	
		...
		if($num_rows > 0)
		{
			...
			else
			{
				...
				echo "<script type='text/javascript'>
                      alert('Thank you for signing up to audition! On the next page, please list any conflicts you have with the show calendar \(keep in mind you may need to advance a month or two to see all of it\)');
